...
// 查询
    fprintf(输出文件, "######## 查询 ########\n");
    fprintf(输出文件, "\"%s\": %d\n", "身高", 散列表_查询_切片键(散列表指针, 原始utf8字符串转unicode切片("身高")));
    fprintf(输出文件, "\"%s\": %d\n", "年龄", 散列表_查询_切片键(散列表指针, 原始utf8字符串转unicode切片("年龄")));
    fprintf(输出文件, "\"%s\": %d\n", "abc",  散列表_查询_切片键(散列表指针, 原始utf8字符串转unicode切片("abc")));
// 更改
    fprintf(输出文件, "######## 更改 ########\n");
    char * 待更改键字符串; 
    unicode切片 待更改键切片;
    ...
    fprintf(输出文件, "原键值: \"%s\": %d\n", 待更改键字符串, 散列表_查询_切片键(散列表指针, 待更改键切片));
    散列表_更改_切片键(散列表指针, 待更改键切片, 80);
