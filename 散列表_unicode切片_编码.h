...
#define  散列表_UNICODE切片_编码_H
    ...
    int    散列表_查询(散列表* 散列表指针, unicode切片 键); //√已测试
    bool   散列表_插入(散列表* 散列表指针, unicode切片 键, 单词类型 值); //√已测试
    bool   散列表_删除(散列表* 散列表指针, unicode切片 键); //√已测试
    bool   散列表_更改(散列表* 散列表指针, unicode切片 键, 单词类型 值); //√已测试
