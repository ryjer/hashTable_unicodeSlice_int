...
#define  散列表_UNICODE切片_编码_H
    ...
    int    散列表_查询_原始utf8字符串键(散列表* 散列表指针, char* utf字符串指针);
    bool   散列表_插入_原始utf8字符串键(散列表* 散列表指针, char* utf字符串指针, 单词类型 值);
    bool   散列表_删除_原始utf8字符串键(散列表* 散列表指针, char* utf字符串指针);
    bool   散列表_更改_原始utf8字符串键(散列表* 散列表指针, char* utf字符串指针, 单词类型 值);
